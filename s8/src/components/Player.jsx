...
export default function Player() {
  ...
  return (
    <section id="player">
      <h2>Welcome {playerName.current ? playerName.current.value : "unknown entity"}</h2> {/* JS 문법 - ||는 앞 값 truthy이면 앞 값 리턴, falsy이면 뒤 값 리턴 */} {/* (cf.) ||가 아니라 ??은 falsy가 아니라 nullish를 따진다. https://thefirstperson.tistory.com/177 */}
      <p>
        <input
          ref={playerName}
          type="text"
